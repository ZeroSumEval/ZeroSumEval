...
def convert_matches_to_df(logs_path: str, max_player_attempts: int, max_time_per_player: int) -> pd.DataFrame:
    matches = []
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max-time-per-player", "-t", help="Maximum number of player time.", type=int, default=100)
